    ...
    <div class="contenedor2">
        <div class="contenedor3">
            ...
            <form action="?controller=publication&method=update" method="POST">
                ...
                <input type="text" name="title" id="title" autofocus required value="<?= $publication->title?>">
                <br>
                <label for="description">Desciption</label>
                <input class="area" type="text" name="description" id="description" required value="<?= $publication->description ?>">
                <br>
                <label for="url_image">Url image</label>
                <input class="file" type="file" name="url_image" id="url_image" required value="<?= $publication->url_image ?>">
                <br>
